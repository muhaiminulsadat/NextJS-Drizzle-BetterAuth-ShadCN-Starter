...
## Corpus Check
- Corpus is ~24,172 words - fits in a single context window. You may not need a graph.

## Summary
- 386 nodes · 446 edges · 36 communities (32 shown, 4 thin omitted)
...
9. `Component Building Principles` - 8 edges
10. `Writing Product Requirement Documents` - 8 edges
...
Cohesion: 0.08
Nodes (23): dependencies, better-auth, class-variance-authority, clsx, dotenv, drizzle-orm, lucide-react, @neondatabase/serverless (+15 more)
...
Cohesion: 0.18
Nodes (10): 📜 Available Scripts, 📦 Features & Capabilities, 🛠️ Getting Started, Installation & Setup, 🤖 Installed AI Agent Skills, 🛡️ License, Next.js 16 + Drizzle ORM + Better Auth + ShadCN Starter, Prerequisites (+2 more)
...
- **Why does `dependencies` connect `Production Dependencies` to `Dev & Build Dependencies`?**
...
- **Should `ShadCN Component Architecture` be split into smaller, more focused modules?**
